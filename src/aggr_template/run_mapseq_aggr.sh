...
cd $PROJECT_PATH/$PROJECT_NAME/analysis/RNA.FB.VDJ && Rscript $PROJECT_PATH/$PROJECT_NAME/analysis/RNA.FB.VDJ/run_seurat.demux_rna.R &
# load ATAC cellranger/kite matrices into Seurat and generate a demultiplexed raw Seurat object
cd $PROJECT_PATH/$PROJECT_NAME/analysis/ATAC.ASAP && Rscript $PROJECT_PATH/$PROJECT_NAME/analysis/ATAC.ASAP/run_seurat.demux_atac.R &
