...
if [ ${#rna_sample_names[@]} != 0 ]; then
    ...
    echo "Running souporcell demultiplexing for RNA samples..."
    echo "This may take a while, please be patient."
    echo "You can monitor the progress in the souporcell log file."
    echo "The log file is located at $PROJECT_PATH/$PROJECT_NAME/pipeline/RNA.FB.VDJ/RNA_demuxing/souporcell_rna.log"
...
if [ ${#atac_sample_names[@]} != 0 ]; then
    ...
    echo "Running souporcell demultiplexing for ATAC samples..."
    echo "This may take a while, please be patient."
    echo "You can monitor the progress in the souporcell log file."
    echo "The log file is located at $PROJECT_PATH/$PROJECT_NAME/pipeline/ATAC.ASAP/ATAC_demuxing/souporcell_atac.log"
